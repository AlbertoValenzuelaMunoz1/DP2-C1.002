...
@GuiService
public class CustomerDeletePassengerService extends AbstractGuiService<Customer, Passenger> {
	...
	public void perform(final Passenger passenger) {
		Collection<BookingRecord> records = this.repository.findBookingRecordByPassengerId(passenger.getId());
