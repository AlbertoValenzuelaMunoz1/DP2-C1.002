...
@GuiService
public class UpdateAirlineAdministratorService extends AbstractGuiService<Administrator, Airline> {
	...
	public void validate(final Airline airline) {
		...
		uniqueIataCode = this.repository.findAirlineByIataCode(airline.getIataCode(), airline.getId()) == null;
