...
@GuiService
public class AdministratorShowBookingService extends AbstractGuiService<Administrator, Booking> {
	// Internal state ---------------------------------------------------------
	...
	public void unbind(final Booking booking) {
		...
		// No hace falta buscar todos los vuelos porque siempre va a ser read only
