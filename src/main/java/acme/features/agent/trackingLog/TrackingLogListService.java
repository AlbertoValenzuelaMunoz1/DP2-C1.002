...
public class TrackingLogListService extends AbstractGuiService<AssistanceAgent, TrackingLog> {
	...
	public void authorise() {
		...
		status = principal.hasRealmOfType(AssistanceAgent.class) && claim != null && claim.getAssistanceAgent().getId() == currentAssistanceAgentId;
	...
	public void unbind(final TrackingLog trackingLog) {
		...
		dataset = super.unbindObject(trackingLog, "lastUpdateMoment", "stepUndergoing", "resolutionPercentage", "claimStatus");
